  ...
  describe('computeLeagueLeaderBoard', () => {
    ...
    it('returns a valid leaderboard when teams are ordered correctly and matches are present', async () => {
      ...
      expect(result).toEqual({
        teams: [
          { teamId: 1, leaderboardPosition: 1, teamPoints: 0 },
          { teamId: 2, leaderboardPosition: 2, teamPoints: 1 },
          { teamId: 3, leaderboardPosition: 3, teamPoints: 2 },
          { teamId: 4, leaderboardPosition: 4, teamPoints: 3 },
          { teamId: 5, leaderboardPosition: 5, teamPoints: 4 },
          { teamId: 6, leaderboardPosition: 6, teamPoints: 5 },
          { teamId: 7, leaderboardPosition: 7, teamPoints: 6 },
          { teamId: 8, leaderboardPosition: 8, teamPoints: 7 },
        ],
        err: 0,
      });
    });
