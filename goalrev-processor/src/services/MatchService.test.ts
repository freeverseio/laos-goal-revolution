...
describe('MatchService', () => {
  ...
  describe('playMatch', () => {
    it('should build request body and send a request to the external API', async () => {
      ...
      const response = await matchService['playMatch'](mockMatch);

      expect(buildRequestBodySpy).toHaveBeenCalledWith(mockMatch);
  ...
  describe('buildRequestBody', () => {
    it('should correctly build the PlayMatchRequest body', () => {
      ...
      const result = matchService['buildRequestBody'](mockMatch);

      expect(result.verseSeed).toBe(mockMatch.seed);
